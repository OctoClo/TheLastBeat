Shader "Custom/Dissolve"
{
    Properties
    {
        ...
        _DissolveDuration ("Dissolve Duration", Range(0, 3)) = 1
        [HideInInspector] _BeginTime ("Begin Time", float) = 0
        [Header(Glow)]
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float dissolveAmount = lerp(0, 1, saturate((_Time.y - _BeginTime) / _DissolveDuration)); 
